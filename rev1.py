...
def get_temperature():
    ...
    return 25.0 + (time.time() % 10)  # For example, between 25.0 and 35.0 degrees Celsius
...
while True:
    ...
    mqtt_client.publish("temperature/topic", payload)
    print(f"Published: {payload}")

    time.sleep(5)  # Publish temperature data every 5 seconds
